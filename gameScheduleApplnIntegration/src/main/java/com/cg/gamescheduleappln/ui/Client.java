...
public class Client {
	...
	public static void main(String[] args) {
		...
		SportsService service=ctx.getBean(SportsServiceImpl.class);
	...
	//	em.getTransaction().commit();
		...
		*/
		...
		d6.setName("Day 6");
		d6.setGames(day6);
		Day dd6=service.addDay(d6);
	//	em.getTransaction().commit();
		System.out.println(dd6.getName() +" "+dd6.getGames());
		...
		System.out.println("output: "+dayDetails);
